...
dependencies {
    ...
    "fabricImplementation"(fabricApi.fabricModule("fabric-command-api-v2", project["fabric_api_version"]))
    "fabricImplementation"(fabricApi.fabricModule("fabric-networking-api-v1", project["fabric_api_version"]))
    "fabricImplementation"(fabricApi.fabricModule("fabric-key-mapping-api-v1", project["fabric_api_version"]))
    "fabricImplementation"(fabricApi.fabricModule("fabric-lifecycle-events-v1", project["fabric_api_version"]))
    "fabricImplementation"(fabricApi.fabricModule("fabric-rendering-v1", project["fabric_api_version"]))
    // Temp
    "fabricImplementation"(fabricApi.fabricModule("fabric-resource-loader-v1", project["fabric_api_version"]))
