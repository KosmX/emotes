...
public class ConfigScreen extends OptionsSubScreen {
    ...
    public static class DummyEntry implements OptionInstance.ValueSet {
        ...
        @Override
        public Function<OptionInstance, AbstractWidget> createButton(OptionInstance.TooltipSupplier tooltipSupplier, Options options, int x, int y, int width, Consumer c) {
    ...
    static class DummyButton extends AbstractWidget {
        ...
        public void renderButton(PoseStack matrices, int mouseX, int mouseY, float delta) {
            drawCenteredString(matrices, Minecraft.getInstance().font, this.getMessage(), this.getX() + this.width / 2, this.getY() + (this.height - 8) / 2, 16777215 | Mth.ceil(this.alpha * 255.0F) << 24);
        }
