...
public class EmoteModerator {
     ...
     */
    public static EventResult verifyEmote(Animation emote, UUID userID) {
        ...
        int hash = EmoteWhitelistManager.calculateEmoteHash(emote);
        boolean isAllowed = EmoteWhitelistManager.isHashAllowed(hash);
