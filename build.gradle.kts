...
plugins {
    ...
    id("org.redlance.dima_dencep.gradle.PublishToDiscord") version "1.0.7"
}
...
allprojects {
    ...
    repositories {
        ...
        maven {
            name = "Maven for PR #2975" // https://github.com/neoforged/NeoForge/pull/2975
            url = uri("https://prmaven.neoforged.net/NeoForge/pr2975")
            content {
...
val ds = publishDiscord {
    ...
    links {
        ...
        from(":minecraft", "curseforge", title = "Fabric/Neoforge (CurseForge)")
        nextRow()
