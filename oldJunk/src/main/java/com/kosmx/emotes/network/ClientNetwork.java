package com.kosmx.emotes.network;


import com.kosmx.emotes.EmotecraftCallbacks;
import com.kosmx.emotes.Main;
import com.kosmx.emotes.main.config.EmoteHolder;
import com.kosmx.emotes.integration.ReplayModProxy;
import com.kosmx.emotes.mixinInterface.EmotePlayerInterface;
import com.kosmx.emotes.mixinInterface.IEmotecraftPresence;
import com.kosmx.emotes.common.emote.EmoteData;
import com.kosmx.emotes.common.network.objects.DiscoveryPacket;
import com.kosmx.emotes.common.network.objects.EmoteDataPacket;
import com.kosmx.emotes.common.network.objects.StopPacket;
...
public class ClientNetwork {
    ...
    public static void init(){
        ClientPlayNetworking.registerGlobalReceiver(MainNetwork.EMOTE_PLAY_NETWORK_PACKET_ID, (client, handler, packetByteBuf, rs)->{
            EmoteDataPacket emotePacket;
            emotePacket = new EmoteDataPacket();
    ...
    public static void sendEmotePacket(EmoteData emote, PlayerEntity player, boolean isRepeating){
        ...
        try{
            PacketByteBuf buf = new PacketByteBuf(Unpooled.buffer());
            EmoteDataPacket emotePacket = new EmoteDataPacket(emote, player.getUuid());
    ...
    public static void clientReceiveEmote(EmoteDataPacket emotePacket){
    ...
    public static void clientReceiveStop(StopPacket stopPacket){
        EmotePlayerInterface player = (EmotePlayerInterface) MinecraftClient.getInstance().world.getPlayerByUuid(stopPacket.getEmote());
